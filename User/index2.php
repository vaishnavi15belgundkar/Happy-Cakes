...
.header .flex .navbar {
    ...
    margin-right: 2rem; /* Add space before icons */
}
...
.header .flex .navbar ul li ul li {
    width: 100%;
    float: none; /* Remove float for dropdown items */
}

.header .flex .navbar ul li ul li a {
    padding: 1.2rem 1.5rem;
    font-size: 1.8rem;
    border-bottom: 1px solid var(--light-bg);
}

.header .flex .navbar ul li ul li:last-child a {
    border-bottom: none;
}
...
/* User Icon Container for Hover Effect */
.header .flex .user-container {
    position: relative;
    display: inline-block;
}

/* Improved Account Box Styling */
...
.header .flex .account-box::before {
    content: '';
    position: absolute;
    top: -1rem;
    right: 3rem;
...
/* Show account box on hover */
.header .flex .user-container:hover .account-box {
    opacity: 1;
    visibility: visible;
...
.header .flex .account-box .delete-btn:hover {
    background: linear-gradient(135deg, #ff1744, var(--pink));
...
@media (max-width: 768px) {
    ...
    .header .flex .user-container .account-box {
        width: calc(100% - 4rem);
        right: -15rem;
        left: auto;
    }

    /* Make account box appear on click for mobile */
    .header .flex .user-container .account-box.mobile-active {
        opacity: 1;
        visibility: visible;
        transform: translateY(0);
    }
...
.header .flex .navbar ul li a:focus,
.header .flex .icons > *:focus {
    outline: 2px solid var(--pink);
    outline-offset: 2px;
}

.header .flex .account-box .delete-btn:focus {
